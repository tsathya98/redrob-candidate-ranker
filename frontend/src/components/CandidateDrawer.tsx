...
import { useCandidate, useExplain, useHealth } from "@/lib/hooks";
  ...
  return (
    <Card className="flex h-full flex-col overflow-hidden p-5">
      <div className="-mr-2 overflow-y-auto pr-2">
        ...
        {/* radar — extra height + smaller radius so axis labels stay inside (don't collide with the line below) */}
        <div className="mt-4 h-56">
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={radar} outerRadius="62%" margin={{ top: 14, bottom: 14, left: 8, right: 8 }}>
        ...
        <div className="mt-1 flex justify-between text-[11px] text-[#6f7596]">
        ...
        {/* optional LLM narration — only shown when an API key is configured (hidden in the offline demo) */}
        {health?.llm_enabled && (
          <div className="mt-4 border-t border-white/5 pt-3">
            ...
            >
              ...
              Narrate with AI <span className="text-[10px] text-violet-300/70">(optional)</span>
            </button>
            <AnimatePresence>
              {explain.data && (
